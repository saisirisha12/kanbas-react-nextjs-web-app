...
import { setQuestions } from "@/app/kanbas/store/reducers/questionsReducer";
...
export default function QuestionNavigator({
        ...
        <div>
          ...
          {question.options.map((option, index) => (
            <div className="form-check" key={index}>
              {currentUser?.role === "FACULTY" && isEditor && (
                <input
      ...
      return (
        <div>
          ...
          <div className="form-check">
            ...
            <label className="form-check-label" htmlFor={`q${question._id}`}>
              True
            </label>
          </div>
          <div className="form-check">
  ...
  }, [currentUser, quizId, setLatestAttempt]);
  ...
  }, [fetchLatestAttempt, fetchQuestions, latestAttempt]);
  ...
  const handleSubmitQuiz = async () => {
    try {
      ...
      await client.addAnswerToQuiz(quizId as string, {
        ...quizAttempt,
        date: submissionDate, // Send as a Date object
      });
      await client.calcUserQuizScore(
        currentUser._id as string,
        quizId as string
      );
        ...
        <div className="col-md-9">
          <div className="card mb-4">
            <div className="card-header d-flex justify-content-between align-items-center">
              ...
              <h5 className="card-title mb-0">{currentQuestion?.points} pts</h5>
            </div>
